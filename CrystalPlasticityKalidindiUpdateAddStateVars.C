...
CrystalPlasticityKalidindiUpdateAddStateVars::calculateSlipRate()
{
  for (const auto i : make_range(_number_slip_systems))
  {
    ...
    _shearstrain[_qp][i]=_slip_increment[_qp][i] * _substep_dt;
    //printf("slip_increment%d = %f\n",i,_slip_increment[_qp][i]);
    //printf("substep_dt = %f\n",_substep_dt);
    //printf("shearstrain%d = %lf\n",i,_shearstrain[_qp][i]);
...
//    CrystalPlasticityStressUpdateBaseAddStateVars::calculateshearstrain(_shearstrain);
}
