...
CrystalPlasticityStressUpdateBaseAddStateVars::CrystalPlasticityStressUpdateBaseAddStateVars(
  ...
  : Material(parameters),
    ...
    equivalent_slip_increment(declareProperty<RankTwoTensor>("equivalent_slip_increment")),
    ...
    RankTwoTensor & equivalent_slip_increment)
{
  ...
  equivalent_shearstrain = equivalent_slip_increment;
  equivalent_shearstrain += equivalent_shearstrain_old;
  equivalent_plastic_strain = sqrt(pow(equivalent_shearstrain(0,0),2)+pow(equivalent_shearstrain(0,1),2)+pow(equivalent_shearstrain(0,2),2)
                                  +pow(equivalent_shearstrain(1,0),2)+pow(equivalent_shearstrain(1,1),2)+pow(equivalent_shearstrain(1,2),2)
                                  +pow(equivalent_shearstrain(2,0),2)+pow(equivalent_shearstrain(2,1),2)+pow(equivalent_shearstrain(2,2),2));
}
