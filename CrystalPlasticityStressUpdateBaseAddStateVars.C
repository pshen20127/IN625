...
//void
//CrystalPlasticityStressUpdateBaseAddStateVars::calculateshearstrain(
//    std::vector<Real> & _shearstrain)
//{
  // Sum up the slip increments to find the accumulated shear strain due to slip
//  for (const auto i : make_range(_number_slip_systems))
